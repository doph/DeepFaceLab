            ...
            for gpu_id in range(gpu_count):
                with tf.device( f'/GPU:{gpu_id}' if len(devices) != 0 else f'/CPU:0' ):
                    ...
                    if 'df' in archi_type:
                        ...
                        self.gpu_src_code = gpu_src_code
                        self.gpu_src_inter_AB_code = gpu_src_inter_AB_code
                        self.gpu_dst_inter_B_code = gpu_dst_inter_B_code
                        self.gpu_pred_src_src = gpu_pred_src_src
                        self.gpu_pred_src_srcm = gpu_pred_src_srcm
